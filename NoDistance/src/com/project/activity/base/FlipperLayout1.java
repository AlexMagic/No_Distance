...
public class FlipperLayout1 extends ViewGroup {
	...
	public FlipperLayout1(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public FlipperLayout1(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
